    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userType', models.CharField(choices=[('Admin', 'Admin'), ('Office user', 'Office user'), ('Field user', 'Field user')], default='Field_user', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('facility', models.OneToOneField(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='website.facilities')),
